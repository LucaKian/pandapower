...
pp.create_ext_grid(net, b1)     # set the slack to bus 1
...
pp.create_measurement(net, "v", "bus", 1.007, 0.004, b3)

# bus voltage_angle
pp.create_measurement(net, "va", "bus", np.deg2rad(-0.749171), 0.001, b2)

# bus, p, q
pp.create_measurement(net, "p", "bus", -0.501, 10., b2)
pp.create_measurement(net, "p", "bus", -0.266, 10., b2)
